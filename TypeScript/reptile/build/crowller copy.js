...
var Crowller = /** @class */ (function () {
    ...
    Crowller.prototype.getData = function (res) {
        var data = {};
        if (fs_1.default.existsSync(this.filePath)) {
            data = JSON.parse(fs_1.default.readFileSync(this.filePath, 'utf-8'));
        }
        data[new Date().getTime()] = res;
        return data;
    };
    Crowller.prototype.writeFile = function (data) {
        fs_1.default.writeFileSync(this.filePath, JSON.stringify(data));
    };
    return Crowller;
}());
new Crowller();
